  ...
  var DICT = {
    iq: {
      links: {
        ...
        quizS: 'تسع أسئلة بالصور، وبعدها يطلع لك طقمك',
    ...
    ar: {
      links: {
        loading: 'لحظة…',
        lead: 'أظافر مركّبة تُصنع بالطلب على مقاسك. اختاري من وين تبدئين:',
        quiz: 'اختبار الستايل',
        quizS: 'تسع أسئلة بالصور، ويطلع لك طقمك',
        shop: 'الأطقم والأسعار',
        shopS: 'كل طقم بسعره المكتوب — ما فيه سعر بالخاص',
        size: 'شلون أعرف مقاسي؟',
    ...
    en: {
      links: {
        ...
        quiz: 'Style quiz',
        quizS: 'Nine picture questions, and your set appears',
