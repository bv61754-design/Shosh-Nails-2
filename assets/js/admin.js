...
(function () {
    ...
    ar: {
      admin: {
        ...
        gd: {
          ...
          recQ: 'ما أقدر أدخل؟',
          recX: 'إذا لم تنفع كلمة المرور بأي شكل، فهذه طريقة مضمونة للعودة إلى اللوحة، ويمكن تنفيذها كاملة من الهاتف.',
        ...
        delOk: 'تم الحذف',
        addOk: 'تمت الإضافة',
        delAsk: 'متأكدة من حذف «{n}»؟ لن نستطيع إرجاعه.',
        idLbl: 'المعرّف',
        copyStr: 'نسخة',
        ...
        sz: {
          ...
          setsX: 'كل مجموعة توزّع رقم مقاس على كل إصبع، والعميلة تستطيع التعديل بعدها.',
          methods: 'طرق القياس',
          methodsX: 'الشرح الذي يظهر للعميلة عن المقاسات.'
        },
        fq: {
        ...
        /* ---- field hints ---- */
        h: {
          deposit: 'العربون نفسه تحددينه في تبويب «الأسعار». الطريقة التي عليها هذا الخيار تطلب العربون وتخصمه من الإجمالي.',
          ...
          details: 'تظهر للعميلة عندما تختار هذه الطريقة عند الدفع. اكتبي الآيبان أو رقم المحفظة هنا.',
        ...
        g: {
          ...
          stepsLbl: 'خطوات «ماذا يحدث بعد الإرسال؟»',
          ...
          bkNever: 'لم تنزّلي نسخة احتياطية قط. كل بياناتك في هذا المتصفح فقط — وإذا مُحيت فلا يمكننا استرجاعها. افتحي تبويب «النسخ الاحتياطي» ونزّلي نسخة.',
        ...
        f2: {
          ...
          notifyEmail: 'الإيميل الذي تستقبلين عليه',
        ...
        gh: {
          ...
          currency: 'مثال: د.ع بالعربي و IQD بالإنجليزي.',
          theme: 'المظهر الذي يراه الزائر أول مرة، ويستطيع تغييره بنفسه.',
          phone: 'بصيغة دولية مع علامة +، مثال: ‎+9647701234567',
          whatsapp: 'أرقام فقط مع رمز الدولة وبدون + وبدون صفر، مثال: 9647701234567',
        ...
        hm: {
          hero: 'الواجهة (Hero)',
          heroX: 'أول ما تراه الزائرة في الصفحة الرئيسية.',
        ...
        /* ---- pricing tab ---- */
        p: {
          intro: 'كل الأسعار بالعملة التي حددتِها في الإعدادات. أي تعديل يظهر مباشرة في اختبار الستايل وصفحة الطلب.',
          ...
          perPatternNailX: 'يُحتسب على عدد الأظافر التي عليها نقشة، بالإضافة لسعر النقشة نفسها.',
          perCharm: 'كل زخرفة',
          ...
          shipping: 'الشحن',
          shippingX: 'تُضاف على كل طلب ما عدا الطلبات التي تتجاوز حد الشحن المجاني.',
          ...
          depositX: 'المبلغ الذي تطلبينه مقدّمًا على طلبات الدفع عند الاستلام، وينخصم من الإجمالي. اكتبي 0 لتعطيله.',
          ...
          extrasX: 'هذه أسعار العناصر نفسها: شكل، طول، لمسة، نقشة، زخرفة، وسعر كل تصميم جاهز. عدّلي أي رقم هنا ويُحفظ فوراً — لا حاجة لفتح تبويب آخر.',
          extrasNone: 'لا توجد عناصر في هذه القائمة بعد.',
        ...
        /* ---- designs tab ---- */
        d: {
          intro: 'التصاميم التي تظهر في صفحة «تصاميم جاهزة». رتّبيها بالسهمين، والأكثر طلباً يظهر تلقائياً حسب عدد الطلبات.',
          price: 'السعر',
          orders: 'عدد الطلبات',
          ...
          cNone: 'بدون لون',
          c1: 'اللون الأساسي',
          c1X: 'اللون الأكبر في الطقم، الذي يغطي أكثر الأظافر. هذا أهم لون في الترشيح.',
          c2: 'اللون الثاني',
          c2X: 'اللون الذي يليه في المساحة. مثلاً لون الظفر المميّز أو الفرنش.',
          c3: 'اللون الثالث',
          ...
          mOccX: 'اختاري كل المناسبات التي يصلح لها — ليست واحدة فقط. كل ما اخترتِ أكثر، ظهر لعميلات أكثر.',
          mVibe: 'طابع الطقم',
          mVibeX: 'كيف يوصف هذا الطقم لو وصفتيه بكلمتين؟ يجوز أكثر من واحد.',
          mAtt: 'مقدار اللفت',
          mAttX: 'إلى أي مدى يلفت الانتباه؟ طقم سادة «بهدوء»، وطقم مليء بالزخارف «ما أحد يعديها».',
          mMetal: 'المعدن',
          ...
          mSeason: 'الموسم',
          mSeasonX: 'اتركيه «احسبه من الألوان» والموقع يحدده بنفسه. غيّريه فقط إذا ظهر خطأ.',
          featured: 'مميّز',
        ...
        gl: {
          ...
          inShopX: 'تظهر القائمة كزر فلترة فوق الأطقم في صفحة «الأطقم الجاهزة».',
          imageX: 'اختيارية. صورة تمثّل القائمة، تظهر في مربّع الاختبار بدل الأيقونة.',
          count: 'عدد الأطقم: {n}'
        },
        ...
        img: {
          ...
          colorX: 'صوّري اللون على ظفر حقيقي تحت إضاءة طبيعية — هذه الصورة هي التي تراها العميلة بدل المربّع الملوّن.',
        ...
        art: {
          ...
          off: 'مكتبة الرسومات غير متاحة الآن. يمكنكِ رفع صورة حقيقية بدلها.',
          groups: {
            stones: 'أحجار',
            metal: 'معادن',
            flowers: 'ورود',
        ...
        o: {
          ...
          all: 'الكل',
          searchPh: 'ابحثي برقم الطلب أو الاسم أو الهاتف…',
          exportCsv: 'تصدير CSV',
          exportOk: 'تم تصدير ملف الطلبات',
          detail: 'تفاصيل الطلب',
          copySum: 'نسخ الملخص',
          waReply: 'الرد على العميلة في واتساب',
          waNo: 'لا يوجد رقم هاتف مسجّل لهذا الطلب.',
          statusLbl: 'حالة الطلب',
          statusOk: 'تم تحديث حالة الطلب',
          delAsk: 'حذف الطلب {n}؟ لن نستطيع إرجاعه.',
          ...
          noteX: 'يمكنكِ كتابة ملاحظاتك أنتِ هنا أيضاً (مثلاً: تم التحصيل).',
          savedOk: 'تم حفظ التعديل',
          delStatus: 'حذف كل «{n}»',
          delAll: 'حذف كل الطلبات',
          delStatusAsk: 'حذف {c} طلب في حالة «{n}»؟ لن نستطيع إرجاعها.',
          delAllAsk: 'حذف كل الطلبات ({c})؟ لن نستطيع إرجاعها.',
          delAllAsk2: 'تأكيد أخير — بعد الحذف ما فيه رجعة. نكمّل؟',
          delManyOk: 'تم حذف {c} طلب',
          delNone: 'لا توجد طلبات في هذه الحالة.',
        ...
        pub: {
          ...
          dirty: 'عندك تعديلات لم تُنشر بعد. انشريها حتى تراها الزبونات.',
          clean: 'كل شيء منشور — ما ترينه هنا هو ما تراه الزبونات.',
          ...
          autoX: 'مرة واحدة فقط: تضعين «مفتاحاً» من حسابك على GitHub وتحفظينه هنا. بعدها كل تعديل تعملينه في اللوحة يُنشر وحده خلال ثوانٍ ويصل الزبونات وكل الأجهزة خلال دقيقة — وترين حالة النشر في الأعلى بجانب العنوان. المفتاح يُحفظ في هذا الجهاز فقط — لا يظهر مع الموقع ولا مع النسخة الاحتياطية.',
          ...
          tokS4: 'انسخي المفتاح، الصقيه هنا، واضغطي «احفظي المفتاح». لن يظهر مرة أخرى على GitHub.',
          tokOpen: 'افتحي صفحة إنشاء المفتاح',
          tokPh: 'github_pat_…',
          tokSave: 'احفظي المفتاح',
          tokSaved: 'انحفظ المفتاح في هذا الجهاز.',
          tokCleared: 'حُذف المفتاح من هذا الجهاز.',
        ...
        b: {
          ...
          resetX: 'ترجع كل المحتوى للنسخة الأصلية التي جاء بها الموقع. الطلبات تبقى محفوظة.',
          resetBtn: 'إعادة الضبط للنسخة الأصلية',
          resetAsk1: 'بترجع كل التعديلات للنسخة الأصلية. متأكدة؟',
          resetAsk2: 'تأكيد أخير: كل الألوان والتصاميم والنصوص التي عدّلتِها سوف تُحذف. نكمل؟',
          resetOk: 'تمت إعادة الضبط',
          passHead: 'كلمة مرور اللوحة',
          passX: 'خطوتان فقط: تكتبين كلمة المرور الجديدة، ثم تنسخين نص جاهز وتلصقينه في ملف واحد على GitHub.',
          ...
          passLocalFail: 'لم نستطع حفظها على هذا الجهاز، لكن أكملي الخطوة 2 وستعمل على كل الأجهزة.',
          passS2: 'الخطوة 2 — عشان تشتغل على كل الأجهزة',
          passS2X: 'كلمة المرور الجديدة تعمل الآن على هذا الجهاز وفي هذه الجلسة فقط. الخطوة 2 هي التي تثبّتها فعلياً: بدونها، أي جهاز آخر — وحتى هذا الجهاز بعد إغلاق الصفحة — سيعود ليقبل الكلمة القديمة.',
          ...
          passHowHead: 'ماذا تفعلين بالضبط بعد النسخ:',
          ...
          passH4: '4) اضغطي مطوّلاً مرة ثانية واختاري «لصق / Paste». المفروض أن يصبح في الملف نفس النص الذي نسختِه، ولا شيء غيره.',
          passH5: '5) اضغطي الزر الأخضر «Commit changes...» فوق، ثم في المربع الذي يظهر اضغطي «Commit changes» مرة ثانية.',
          passH6: '6) انتظري دقيقة إلى دقيقتين، وبعدها افتحي الموقع من أي جهاز — كلمة المرور الجديدة صارت شغّالة.',
          passSafe: 'النص الذي نسختِه لا يحتوي كلمة المرور نفسها، بل «بصمة» مشفّرة لها. أي لو رآه أحد لا يستطيع معرفة كلمتك، ومن الآمن حفظه في GitHub.',
          passSafePlain: 'هذه النسخة فيها كلمة المرور نفسها مكتوبة، وملفات GitHub يستطيع أي أحد رؤيتها. اختاري كلمة مرور تخص هذا الموقع فقط.',
          passReuse: 'لا تستخدمين كلمة مرور تستخدمينها في الإيميل أو البنك أو أي حساب ثاني. خصّصي كلمة مرور لهذا الموقع لحالها.',
          passGuard: 'ملاحظة مهمة: هذه الكلمة تحمي لوحة التحكم فقط. اللوحة تعدّل نسخة المحتوى داخل المتصفح الذي فُتحت منه، ولا تستطيع تغيير ما يراه زوار الموقع. المحتوى المنشور يتغيّر من تبويب «النشر» — ثلاث ضغطات وترفعينه من حسابك على GitHub.',
          passRedo: 'أعيدي فتح الخطوة 2',
          passRedoX: 'محتوى الملف محفوظ لك في هذه الجلسة، ولا حاجة لكتابة كلمة المرور من جديد.',
          ...
          notifyS4: '4) اكتبي إيميلك في خانة «الإيميل الذي تستقبلين عليه» حتى يظهر لك هنا للتذكير.',
          ...
          testBody: 'هذه رسالة اختبار أرسلتها لوحة تحكم شوش نيل للتأكد من وصول إشعارات الطلبات. إذا وصلتك، فالإعداد تمام.'
        }
      }
    },
    ...
    en: {
      admin: {
        ...
        gh: {
          ...
          currency: 'For example د.ع in Arabic and IQD in English.',
          theme: 'What a first-time visitor sees; they can still switch it themselves.',
          phone: 'International format with a leading +, e.g. +9647701234567',
          whatsapp: 'Digits only, with the country code, no + and no leading zero, e.g. 9647701234567',
        ...
        gl: {
          ...
          inShopX: 'The list appears as a filter button above the sets on the Ready designs page.',
          imageX: 'Optional. A photo for the list, shown on its quiz tile instead of the icon.',
          count: '{n} set(s) in it'
        },
  ...
  /* the four built-in occasion characters a list can borrow, plus «بدون» */
  function seedOpts() {
    var arr = (SN.Store && SN.Store.get) ? SN.Store.get('matchAxes.occasion') : null;
    var out = [{ v: '', l: t('admin.gl.seedNone') }], i;
  ...
  function schema(id) {
    switch (id) {
      ...
      /* The owner's own groupings of sets. `seed` borrows one of the four
         built-in occasion characters for the set the quiz builds when a
         customer picks this list; leaving it empty just means the quiz
         builds from her own occasion answer instead. */
      case 'groups': return {
        key: 'groups',
        fields: [
          F('name', 't', 'admin.f.name'),
          F('desc', 'tarea', 'admin.f.desc', { wide: true, rows: 3 }),
          F('ico', 'select', 'admin.f.icon', { opts: uiIconOpts }),
          F('seed', 'select', 'admin.gl.seed', { hint: 'admin.gl.seedX', opts: seedOpts }),
          F('image', 'image', 'admin.img.head', { wide: true, maxPx: MAX_DESIGN, hint: 'admin.gl.imageX' }),
          F('inQuiz', 'bool', 'admin.gl.inQuiz', { hint: 'admin.gl.inQuizX' }),
          F('inShop', 'bool', 'admin.gl.inShop', { hint: 'admin.gl.inShopX' }),
          F('active', 'bool', 'admin.d.active')
        ],
        blank: function () {
          return {
            id: '', name: { ar: '', en: '' }, desc: { ar: '', en: '' },
            ico: 'sparkle', seed: '', image: '',
            inQuiz: true, inShop: true, active: true
          };
        },
        preview: function (it) {
          if (it && it.image) return photoChip(it.image);
          return el('span', { 'class': 'adm-ico-pv', html: icon(str(it.ico) || 'sparkle', 20) });
        },
        sub: function (it) {
          var n = 0, arr = sList('designs'), i;
          for (i = 0; i < arr.length; i++) {
            if (arr[i] && Array.isArray(arr[i].groups) && arr[i].groups.indexOf(it.id) !== -1) n++;
          }
          return t('admin.gl.count', { n: n }) + (it.active === false ? ' · ' + t('common.no') : '');
        }
      };
  ...
  function renderDesigns() {
    ...
    var def = {
      ...
      fields: [
        ...
        F('groups', 'multi', 'admin.d.groups', { wide: true, hint: 'admin.d.groupsX', opts: listOpts('groups', true) }),
  ...
  /* The shop's country code, used only to repair a number a customer typed in
     her own local form. Iraq is 964; an Iraqi mobile is 07XXXXXXXXX (eleven
     digits) or 7XXXXXXXXX written without the zero. A number she already wrote
     in international form is left exactly as she wrote it. */
  var WA_CC = '964';

  function custWaLink(phone, text) {
    var digits = str(phone).replace(/[^0-9]/g, '');
    if (!digits) return '';
    digits = digits.replace(/^0+0/, '');                       /* 00964... -> 964... */
    if (digits.charAt(0) === '0') digits = WA_CC + digits.slice(1);   /* 07... -> 9647... */
    else if (digits.length <= 10) digits = WA_CC + digits;            /* 7...  -> 9647... */
  ...
  function simpleTab(id) {
    return function () {
      ...
      box.appendChild(card([crud(def, {
        ...
        help: id === 'shapes' ? t('admin.shapeIds', { n: shapeIdList() })
          : (id === 'groups' ? t('admin.gl.intro') : null),
        onChange: sideCounts
      })]));
      return box;
    };
